package com.example.demo.service.impl.util;
...
public class HttpClientUtil {
	...
	/*
	 * private static final String AUTHORIZATION = "Bearer  eyJhbGciOiJSUzI1NiJ9.eyJzdWIiOiJtZWlqa" +
	 * "WUiLCJpYXQiOjE0NzkxMDg3MzN9.C_rGQh5Rt7-tGIEaay1h5cjRC6QLmG2Id-CHzymhm05vtDqNavF_70" +
	 * "eOhNpyr0PEaxf_vkaAjqkQ598Lns5qZ502lM-7qDbFpGv6KsdUu6rU6egbRE0GMi2sKJdbE0btgQNC3KIb" +
	 * "CxjKsCCWSVgXk5onQo8ye9GWICTr92rQh-Q";
	 */
	...
	*/
	private static CloseableHttpClient createHttpClient() {
		...
		return HttpClients.custom().setDefaultRequestConfig(config).setMaxConnTotal(200).setMaxConnPerRoute(70).build();
	}
	...
	public static String httpGetRequest(String url, int socketTimeout, int connectTimeout) {
		HttpGet httpGet = new HttpGet(url);
	 ...
	 */
	/*
	 * public static String httpPostRequest(String url, Map<String, String> params, Header header) throws
	 * UnsupportedEncodingException { HttpPost httpPost = new HttpPost(url); ArrayList<NameValuePair> pairs =
	 * covertParams2NVPS(params); if (header != null) { httpPost.setHeader(header); } else {
	...
	*/
	...
	public static String httpPostRestRequest(String url, String json) {
		...
		entity.setContentType(ContentTypes.application_x_www_form_urlencoded);
	...
	public static String httpPostJsonRequest(String url, String json) {
		HttpPost httpPost = new HttpPost(url);
		StringEntity entity = new StringEntity(json, HTTP.UTF_8);
		entity.setContentType(ContentTypes.application_json);
		httpPost.setEntity(entity);
		return getResult(httpPost);
	}
